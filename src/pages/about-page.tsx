    ...
    <main className="bg-white">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-6 leading-8 text-gray-600">
                ...
                working to create meaningful and lasting change in the lives
                of people who need support and opportunity.
              </p>

              <p className="mt-4 leading-8 text-gray-600">
                Since 2010, our work has been centered around understanding
                the needs of communities and working alongside them to find
                practical, sustainable solutions.
              </p>

              <p className="mt-4 leading-8 text-gray-600">
                We believe that development is strongest when communities
                participate in the process and have the confidence,
                resources and opportunities to shape their own future.
              </p>
            </div>

            {/* Right */}
            <div className="relative">
              <div className="absolute -right-4 -top-4 h-full w-full rounded-3xl bg-orange-100" />
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-14 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl leading-7 text-gray-600">
              Our journey has been shaped by the people and communities
              we work with.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            {/* Timeline Line */}
            <div className="absolute left-5 top-0 hidden h-full w-0.5 bg-orange-200 md:block" />
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-6 leading-8 text-gray-600">
                Many communities continue to face challenges that limit
                access to education, healthcare, safe sanitation,
                livelihoods and equal opportunities.
              </p>

              <p className="mt-4 leading-8 text-gray-600">
                We exist because these challenges should not determine
                someone's future. We believe people deserve the opportunity
                to live with dignity, make informed choices and build a
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <Card className="border-0 bg-orange-50 shadow-sm">
                <CardContent className="p-6">
                  ...
                  <p className="mt-3 leading-7 text-gray-600">
                    Creating access to opportunities that can improve
                    people's lives.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 bg-blue-50 shadow-sm">
                <CardContent className="p-6">
                  ...
                  <p className="mt-3 leading-7 text-gray-600">
                    Ensuring people are treated with respect, equality
                    and dignity.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 bg-orange-50 shadow-sm">
                <CardContent className="p-6">
                  ...
                  <p className="mt-3 leading-7 text-gray-600">
                    Building solutions that can continue creating impact
                    over the long term.
                  </p>
                </CardContent>
              </Card>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-14 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl leading-7 text-blue-100">
              Our values shape the way we work with communities,
      ...
      <section className="px-6 py-20 md:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-14 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl leading-7 text-gray-600">
              Meaningful community work is possible because of people
              who dedicate their time, knowledge and energy to the cause.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Card className="border-0 bg-gray-50 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
              <CardContent className="p-7">
                ...
                <p className="mt-3 leading-7 text-gray-600">
                  Our leadership team provides direction, accountability
                  and a long-term vision for the organization.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 bg-gray-50 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
              <CardContent className="p-7">
                ...
                <p className="mt-3 leading-7 text-gray-600">
                  Our field teams work directly with communities,
                  understand local needs and help implement initiatives.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 bg-gray-50 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
              <CardContent className="p-7">
                ...
                <p className="mt-3 leading-7 text-gray-600">
                  Volunteers contribute their time, skills and compassion
                  to strengthen our work and reach more people.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid gap-6 md:grid-cols-4">
            ...
            <Card className="border-0 shadow-sm">
              <CardContent className="p-6">
                ...
                <p className="mt-3 leading-7 text-gray-600">
                  We begin by listening to communities and understanding
                  their real needs.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-sm">
              <CardContent className="p-6">
                ...
                <p className="mt-3 leading-7 text-gray-600">
                  We study local challenges and identify practical ways
                  to address them.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-sm">
              <CardContent className="p-6">
                ...
                <p className="mt-3 leading-7 text-gray-600">
                  We focus on building capabilities that can continue
                  creating impact beyond individual projects.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="px-6 py-20 md:py-24">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="rounded-3xl bg-orange-50 p-8 text-center md:p-14">
            ...
            <p className="mt-6 font-semibold uppercase tracking-wide text-orange-500">
              Our Commitment
            </p>

            <h2 className="mt-3 text-3xl font-bold text-gray-900 md:text-4xl">
              Creating Change With Respect,
              Responsibility & Hope
            </h2>
            ...
            <p className="mx-auto mt-6 max-w-3xl leading-8 text-gray-600">
              ...
              provide support, but to help create opportunities through
              which people can build stronger and more independent futures.
            </p>
      ...
      <section className="bg-blue-900 px-6 py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <Button
            className="mt-8 rounded-full bg-orange-500 px-7 py-6 text-base font-semibold text-white hover:bg-orange-600"
          >
            Get Involved
